...
첫 공개 버전은 전체 커리큘럼 로드맵과 핵심 글 4편으로 구성합니다.
...
- `/industry/[slug]`: 공식 발표 하나를 학습 질문과 관련 교재로 연결하는 해설 노트
...
- `/glossary`에서 핵심 용어를 검색, 카테고리, 난이도 기준으로 찾고 쉬운 설명과 실무 맥락을 확인합니다.
