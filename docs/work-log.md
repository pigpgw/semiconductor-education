...
1. 글 상세 90초 요약 카드를 설계하고 DRAM/HBM/EUV 3편에 적용합니다.
2. 각 글 출처 확인일과 공식 자료 해석 메모를 보강합니다.
3. 용어 사전 검색/필터 UX를 보강합니다.
4. `/industry/[slug]` 상세 해설 노트 구조를 설계합니다.
5. 공식 RSS/API 후보를 출처별로 조사하고 `feedUrl` 필드 추가 여부를 결정합니다.
